...
var (
	...
	pbfHandler = tiles.PBFHandler{
		DBcfg: &tiles.DBPoolConfig{
			...
			Host:         os.Getenv("PG__HOST"),     // localhost
			Port:         os.Getenv("PG__PORT"),     // 5432
			User:         os.Getenv("PG__USER"),     // dustinwilson
			DBName:       os.Getenv("PG__DATABASE"), // osm
			SSLMode:      os.Getenv("PG__SSL_MODE"), // disble
		},
